...
$query = mysqli_query($mysqli, "SELECT id, title, author, year, image FROM books WHERE user='$sessionusername'");
?>
<!DOCTYPE html>
<html>
    <head>
    ...
    <body>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class='align-middle'><div class="btn-group" role="group" aria-label="Basic example">
                    <button type="button" data-toggle="tooltip" data-placement="bottom" title="Edit" class="btn btn-outline-warning edit"><i class="fas fa-xl fa-pen"></i></button><button onclick="edit($(this).parent().parent().parent(), '<?php echo $row['id'] ?>')" type="button" data-toggle="tooltip" data-placement="bottom" title="Save" hidden class="btn btn-outline-warning save"><i class="fas fa-xl fa-save"></i></button><button data-toggle="tooltip" data-placement="bottom" title="Delete" onclick="deletebook($(this).parent().parent().parent(), '<?php echo $row['title'] ?>')" type="button" class="btn btn-outline-danger delete"><i class="fas fa-xl fa-trash"></i></button></div>
                  </td>
                </tr>
                <?php
                  }
        ...
        <script>
        function deletebook(row, title) {
          var xhr = new XMLHttpRequest();
          xhr.open("GET", "ajax/delete.php?title=" + title, true);
          xhr.send();
